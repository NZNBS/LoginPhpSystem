...
public class Auth extends AsyncTask<String, Void, String> {
    private WeakReference<MRZPHP> weakActivity;
    private ProgressDialog pDialog;
    private String URLSERVER = "http://mrz.dx.am/login.php";
    ...
    private boolean isServiceRunning() {
        ...
        if (manager != null) {
            for (ActivityManager.RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
                if (FloatingActivityService.class.getName().equals(service.service.getClassName())) {
                    return true;
                }
            }
        }
